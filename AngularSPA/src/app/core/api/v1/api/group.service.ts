...
export class GroupService {
  ...
  public apiGroupGet(
    ...
    return this.httpClient.get<Array<Group>>(
      `${this.configuration.basePath}/api/Group`,
      {
  ...
  public apiGroupIdDelete(
    ...
    return this.httpClient.delete<Group>(
      `${this.configuration.basePath}/api/Group/${encodeURIComponent(
        String(id)
      )}`,
      {
        responseType: <any>responseType_,
  ...
  public apiGroupIdPut(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling apiGroupIdPut.'
      );
    }
