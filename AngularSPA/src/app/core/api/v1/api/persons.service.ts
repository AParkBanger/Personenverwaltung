...
export class PersonsService {
  ...
  public apiPersonsGet(
    ...
    return this.httpClient.get<Array<Person>>(
      `${this.configuration.basePath}/api/Persons`,
      {
  ...
  public apiPersonsIdDelete(
    ...
    return this.httpClient.delete<Person>(
      `${this.configuration.basePath}/api/Persons/${encodeURIComponent(
        String(id)
      )}`,
      {
        responseType: <any>responseType_,
